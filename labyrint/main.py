...
while True:
    ...
    if finish != True:
        ...
        if level == 1:
            ...
            player.refresh(10, win_height -80)
            monster = Enemy("cyborg.png", win_width/2 -50, 240, 8)
            w1 = Wall((22, 201, 187), 100, 20, 580, 10)
            ...
            w2 = Wall((22, 201, 187), 100, 85, 10, 450)
            w3 = Wall((22, 201, 187), 170, 20, 10, 400)
            w4 = Wall((22, 201, 187), 230, 85, 10, 450)
            w5 = Wall((22, 201, 187), 300, 85, 10, 150)
            w6 = Wall((22, 201, 187), 300, 300, 10, 100)
            w7 = Wall((22, 201, 187), 370, 85, 10, 320)
            w8 = Wall((22, 201, 187), 370, 300, 230, 10)
            w9 = Wall((22, 201, 187), 210, 30, 200, 10)#18
            w10 = Wall((22, 201, 187), 430, 20, 10, 230)
            w11 = Wall((22, 201, 187), 480, 80, 10, 230)
            w12 = Wall((22, 201, 187), 530, 20, 10, 230)
            w13 = Wall((22, 201, 187), 580, 80, 10, 230)
            w14 = Wall((22, 201, 187), 680, 20, 10, 500)
